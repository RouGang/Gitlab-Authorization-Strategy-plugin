package com.hunantv.gitlab.api;
...
import com.hunantv.gitlab.api.http.GitlabHTTPRequestor;
import com.hunantv.gitlab.api.http.Query;
import com.hunantv.gitlab.api.models.GitlabAccessLevel;
import com.hunantv.gitlab.api.models.GitlabBranch;
import com.hunantv.gitlab.api.models.GitlabCommit;
import com.hunantv.gitlab.api.models.GitlabGroup;
import com.hunantv.gitlab.api.models.GitlabGroupMember;
import com.hunantv.gitlab.api.models.GitlabIssue;
import com.hunantv.gitlab.api.models.GitlabMergeRequest;
import com.hunantv.gitlab.api.models.GitlabMilestone;
import com.hunantv.gitlab.api.models.GitlabNamespace;
import com.hunantv.gitlab.api.models.GitlabNote;
import com.hunantv.gitlab.api.models.GitlabProject;
import com.hunantv.gitlab.api.models.GitlabProjectHook;
import com.hunantv.gitlab.api.models.GitlabProjectMember;
...
public class GitlabAPI {
    ...
    private void applyIssue(GitlabHTTPRequestor requestor, int projectId, int assigneeId, int milestoneId, String labels, String description,
            String title) {
